  ...
  return (
    <div className="min-h-screen flex justify-center items-center w-full">
      <div className="w-full max-w-sm p-6 m-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
        <h1 className="md:text-4xl font-bold text-center">Register</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
          ...
          <div className="mt-6">
            <input
              type="submit"
              className="w-full px-6 py-2.5 text-sm font-medium tracking-wide text-white bg-gray-800 rounded-lg"
              value="Sign Up"
            />
          </div>
        </form>
